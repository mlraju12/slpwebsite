...
export const PRODUCT_PAGES = {
  ...
  tidesync: {
    ...
    pricing: {
      ...
      loginHref: '/login',
      plans: [
        { name: 'Free Trial', variant: 'silver', planId: 'free_trial', price: '$0', period: '', note: 'Full access to explore TideSync', description: 'Try TideSync with your SLP account', features: ['Unified data view', 'Automated sync workflows', 'Oracle Cloud integration'], featured: true, ctaHref: '/signup', ctaLabel: 'Start free trial' },
      ],
    },
  },
};
