...
export const PRODUCT_PAGES = {
  ...
  tidesync: {
    ...
    heroSlides: [
      { title: 'TideSync – Unified Oracle Cloud Data', image: '/cloudfish/oracle-hcm-workforce.png', textTone: 'light' },
      { title: 'One view across HCM, ERP, and analytics', image: '/cloudfish/cloudfish-all-in-one-platform-funky.png', textTone: 'dark' },
    ],
    ctaLoginHref: '/login',
    ctaTrialHref: '/signup',
    features: {
    ...
    pricing: {
      title: 'Get Started',
      subtitle: 'Start with a free trial. Same account as CloudFish.',
      loginHref: '/login',
      plans: [
        { name: 'Free Trial', variant: 'silver', planId: 'free_trial', price: '$0', period: '', note: 'Full access to explore TideSync', description: 'Try TideSync with your SLP account', features: ['Unified data view', 'Automated sync workflows', 'Oracle Cloud integration'], featured: true, ctaLabel: 'Start free trial' },
      ],
    },
  },
};
