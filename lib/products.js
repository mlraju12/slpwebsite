...
export const PRODUCT_PAGES = {
  ...
  tidesync: {
    ...
    heroSlides: [
      {
        image: '/tidesync/hero-slide-1-bridge-punches.png',
        imageFit: 'cover',
        imagePosition: 'object-top',
        textTone: 'light',
        ctaLabel: 'Schedule Demo',
        ctaHref: 'mailto:info@slpmicrosystems.com?subject=TideSync%20Schedule%20Demo',
        ctaStyle: 'yellow',
      },
      {
        image: '/tidesync/hero-tailored-business.svg',
        textTone: 'light',
        ctaLabel: 'Contact Us',
        ctaHref: '/#contact',
        ctaStyle: 'yellow',
      ...
      {
        image: '/tidesync/hero-slide-4-data-security.png',
        imageFit: 'cover',
        imagePosition: 'object-center',
        textTone: 'light',
        ctaLabel: 'Bring Punches',
