...
export default function CloudFishSignupPage() {
      ...
      <main className="min-h-screen flex items-center justify-center px-4 py-16 bg-slate-50 pt-24">
        <div className="w-full max-w-md bg-white rounded-xl shadow-lg border border-slate-200 p-8">
          ...
          <p className="text-slate-600 text-sm mb-6">
            Click the link to verify your account. Then you can log in to CloudFish and complete your purchase.
          </p>
          <Link
            href="/cloudfish/login"
  ...
  return (
    <main className="min-h-screen flex items-center justify-center px-4 py-16 bg-slate-50 pt-24">
      <div className="w-full max-w-md bg-white rounded-xl shadow-lg border border-slate-200 p-8">
        <Link href="/products/cloudfish" className="text-slate-600 hover:text-teal text-sm mb-6 inline-block">
          ← Back to CloudFish
        </Link>
        <h1 className="text-2xl font-bold text-slate-900 mb-1">Create Account</h1>
        <p className="text-slate-600 text-sm mb-6">Sign up to use CloudFish. Your account works in the CloudFish app.</p>
        {error && (
        ...
        <p className="mt-6 text-center text-sm text-slate-600">
          ...
          <Link href="/cloudfish/login" className="text-teal font-semibold hover:underline">
            Log in
          </Link>
        </p>
      </div>
