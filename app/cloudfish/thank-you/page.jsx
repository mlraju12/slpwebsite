...
export default function CloudFishThankYouPage() {
  return (
    <main className="min-h-screen flex items-center justify-center px-4 py-16 bg-slate-50 pt-24">
      <div className="w-full max-w-lg bg-white rounded-xl shadow-lg border border-slate-200 p-8 text-center">
        ...
        <p className="text-slate-600 mb-8">
          Your CloudFish plan is now active. Open the CloudFish app to start using it.
        </p>
        <Link
        ...
        <p className="mt-6">
          <Link href="/products/cloudfish" className="text-slate-600 hover:text-teal text-sm">
            ← Back to CloudFish
          </Link>
        </p>
      </div>
